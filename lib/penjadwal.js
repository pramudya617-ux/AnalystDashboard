...
/* Ikut DATA_DIR supaya jam penarikan terakhir selamat dari redeploy Railway;
   tanpa itu tiap deploy memicu penarikan baru seolah belum pernah jalan. */
const DATA = (() => {
...
export async function tarikSekarang(alasan = "jadwal") {
  ...
  /* Penanda mulai ikut disimpan supaya halaman bisa memberitakan penarikan yang
     sedang berlangsung; status di memori tidak terlihat oleh proses render. */
  simpan({ ...baca(), berjalanSejak: mulai });
  try {
